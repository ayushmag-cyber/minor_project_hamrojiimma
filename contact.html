    ...
    <div class="wrapper-contact">
      ...
      <form id="contact-form">
        ...
        <div class="input-box">
          ...
          <textarea id="message" placeholder="Write your message here..." required style="padding-left: 40px; border-radius: 5px; border: 1px solid rgb(8, 8, 8); background: transparent; color: black; resize: vertical;"></textarea>
